...
var docsCmd = &cobra.Command{
  ...
  - README.md – project overview, platform layers, landing zones
...
func runDocs(cmd *cobra.Command, args []string) error {
	...
	bold.Fprintf(os.Stderr, "📄 Generating docs for project: %s\n\n", cfg.Metadata.Name)
	...
	green.Fprintln(os.Stderr, "✅ Documentation generation complete.")
...
func generateReadme(cfg *config.LZConfig, root string) string {
	...
	sb.WriteString(fmt.Sprintf("# %s – Azure Landing Zone\n\n", cfg.Metadata.Name))
